...
async def gen_link_s(bot, message):
    ...
    await message.reply(f"Here is your Link:\nhttps://t.me/Poster_Flix_Bot?start={outstr}")    
    
@Client.on_message(filters.command(['batch', 'pbatch']) & filters.create(allowed))
async def gen_link_batch(bot, message):
    if " " not in message.text:
        return await message.reply("Use correct format.\nExample <code>/batch https://t.me/Poster_Flix_Bot/10 https://t.me/Poster_Flix_Bot/20</code>.")
    ...
    return await sts.edit(f"Here is your link https://t.me/Poster_Flix_Bot?start=DSTORE-{b_64}")
    ...
    await sts.edit(f"Here is your link\nContains `{og_msg}` files.\n https://t.me/Poster_Flix_Bot?start=BATCH-{file_id}")
